...
| Risk | Mitigation |
| --- | --- |
| Remote installer compromise | Track remote installers in `agentic-tools.lock.yaml` and audit with `scripts/audit-remote-installers.sh`. |
| Moving package versions | Prefer lockfile-pinned versions and document exceptions. |
